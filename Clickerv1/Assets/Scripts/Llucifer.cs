...
public class Llucifer : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        FuetStats.GetComponent<Text>().text = "Llucifer: " + numberofFuets;
        fakeText.GetComponent<Text>().text = "Llucifer " + Fuetvalue + " Aigua";
        realText.GetComponent<Text>().text = "Llucifer " + Fuetvalue + " Aigua";
