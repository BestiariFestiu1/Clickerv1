...
public class BanyaVerda : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        FuetStats.GetComponent<Text>().text = "Banyes: " + numberofFuets;
        fakeText.GetComponent<Text>().text = "Banya " + Fuetvalue + " Aigua";
        realText.GetComponent<Text>().text = "Banya " + Fuetvalue + " Aigua";
